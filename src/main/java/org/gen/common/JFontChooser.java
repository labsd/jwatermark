...
{
	final Logger log = LoggerFactory.getLogger(JFontChooser.class);
    // class variables
    /**
    ...
    private static final Font DEFAULT_SELECTED_FONT = new Font(Messages.getString("jfontchooser.serif"), Font.PLAIN, 12); //$NON-NLS-1$
    private static final Font DEFAULT_FONT = new Font(Messages.getString("jfontchooser.dialog"), Font.PLAIN, 10); //$NON-NLS-1$
    ...
    {
        "8", "9", "10", "11", "12", "14", "16", "18", "20", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
        "22", "24", "26", "28", "36", "48", "72", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
        "96", "120", "150", "210", "360", "480", "720", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    };
    ...
    {
        return (Messages.getString("jfontchooser.version")); //$NON-NLS-1$
    }
    ...
    {
        protected static final String ACTION_NAME = "OK"; //$NON-NLS-1$
    ...
    {
        protected static final String ACTION_NAME = "CANCEL"; //$NON-NLS-1$
        private JDialog dialog;
    ...
    protected JDialog createDialog(Component parent)
    {
        ...
        JDialog dialog = new JDialog(frame, (Messages.getString("jfontchooser.select_font")), true); //$NON-NLS-1$
        ...
        inputMap.put(KeyStroke.getKeyStroke("ESCAPE"), cancelAction.getValue(Action.DEFAULT)); //$NON-NLS-1$
        inputMap.put(KeyStroke.getKeyStroke("ENTER"), okAction.getValue(Action.DEFAULT)); //$NON-NLS-1$
    ...
    protected JPanel getFontFamilyPanel()
    {
        if (fontNamePanel == null)
        {
            ...
            JLabel label = new JLabel((Messages.getString("jfontchooser.font_name"))); //$NON-NLS-1$
    ...
    protected JPanel getFontStylePanel()
    {
        if (fontStylePanel == null)
        {
            ...
            JLabel label = new JLabel((Messages.getString("jfontchooser.font_style"))); //$NON-NLS-1$
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getFontSizePanel()
    {
        if (fontSizePanel == null)
        {
            ...
            JLabel label = new JLabel((Messages.getString("jfontchooser.font_size"))); //$NON-NLS-1$
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getSamplePanel()
    {
        if (samplePanel == null)
        {
            Border titledBorder = BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), (Messages.getString("jfontchooser.sample"))); //$NON-NLS-1$
    ...
    protected JTextField getSampleTextField()
    {
        if (sampleText == null)
        {
            ...
            sampleText = new JTextField((Messages.getString("jfontchooser.example_text"))); //$NON-NLS-1$
    ...
    protected String[] getFontStyleNames()
    {
        if (fontStyleNames == null)
        {
            ...
            fontStyleNames[i++] = (Messages.getString("jfontchooser.text_style_plain")); //$NON-NLS-1$
            fontStyleNames[i++] = (Messages.getString("jfontchooser.text_style_bold")); //$NON-NLS-1$
            fontStyleNames[i++] = (Messages.getString("jfontchooser.text_style_italic")); //$NON-NLS-1$
            fontStyleNames[i++] = (Messages.getString("jfontchooser.text_style_bold_italic")); //$NON-NLS-1$
        }
